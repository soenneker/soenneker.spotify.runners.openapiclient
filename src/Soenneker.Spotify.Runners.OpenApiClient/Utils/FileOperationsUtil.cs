...
using Soenneker.Spotify.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Spotify.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Spotify:ClientGenerationUrl"] ?? "https://developer.spotify.com/reference/web-api/open-api-schema.yaml";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c SpotifyOpenApiClient -n {Constants.Library}",
